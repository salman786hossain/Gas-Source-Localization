...
data_100x100 = pd.read_csv("QGIS_upsampling_100m_day1.csv")
...
# Load the CO2 data for each day
data_200x200 = pd.read_csv("QGIS_upsampling_200m_day1.csv")
...
# Load the CO2 data for each day
data_300x300 = pd.read_csv("QGIS_upsampling_300m_day1.csv")
...
# Final output
print("Location in cartesian from 100m^2 (day 1):", [p1,q1])
print("Location in cartesian from 200m^2 (day 1):", [p2,q2])
print("Location in cartesian from 300m^2 (day 1):", [p3,q3])

print("Coordinate in polar from 100m^2 (day 1):", [latitude1,longitude1])
print("Coordinate in polar from 200m^2 (day 1):", [latitude2,longitude2])
print("Coordinate in polar from 300m^2 (day 1):", [latitude3,longitude3])
