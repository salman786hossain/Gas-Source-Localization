...
data_100x100 = pd.read_csv("QGIS_upsampling_100m_day3.csv")
...
# Load the CO2 data for each day
data_200x200 = pd.read_csv("QGIS_upsampling_200m_day3.csv")
...
# Load the CO2 data for each day
data_300x300 = pd.read_csv("QGIS_upsampling_300m_day3.csv")
...
# plt.xlim([,])
# plt.ylim([,])
plt.title("Coordinate Locations of different testing heights & areas with the Car location (Day 3)",fontsize=20,pad =20)
plt.show()
...
# Final output
print("Location in cartesian from 100m^2 (day 3):", [p1,q1])
print("Location in cartesian from 200m^2 (day 3):", [p2,q2])
print("Location in cartesian from 300m^2 (day 3):", [p3,q3])

print("Coordinate in polar from 100m^2 (day 3):", [latitude1,longitude1])
print("Coordinate in polar from 200m^2 (day 3):", [latitude2,longitude2])
print("Coordinate in polar from 300m^2 (day 3):", [latitude3,longitude3])
