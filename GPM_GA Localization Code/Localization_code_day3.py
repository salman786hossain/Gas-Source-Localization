...
data_100x100 = pd.read_csv("QGIS_Upsampling_data/QGIS_upsampling_100m_day3.csv")
...
chunk_size_100 = int(len(data_100) / 18)
...
# Load the CO2 data for each day
data_200x200 = pd.read_csv("QGIS_Upsampling_data/QGIS_upsampling_200m_day3.csv")
...
# Split the data into 5 chunks
chunk_size_200 = int(len(data_200) / 21)
...
# Load the CO2 data for each day
data_300x300 = pd.read_csv("QGIS_Upsampling_data/QGIS_upsampling_300m_day3.csv")
...
# plt.xlim([,])
# plt.ylim([,])
plt.title("Coordinate Locations of different testing heights & areas with the Car location (Day 3)",fontsize=20)
plt.show()
...
# Final output
print("Coordinate in cartesian from 100m^2 (day 3):", [p1,q1])
print("Coordinate in cartesian from 200m^2 (day 3):", [p2,q2])
print("Coordinate in cartesian from 300m^2 (day 3):", [p3,q3])

print("Coordinate in cartesian from 100m^2 (day 3):", [latitude1,longitude1])
print("Coordinate in cartesian from 200m^2 (day 3):", [latitude2,longitude2])
print("Coordinate in cartesian from 300m^2 (day 3):", [latitude3,longitude3])
...
print("Distance from the ground truth 100m^2 (day 3):", (geodesic(Ground_truth, coordinate_100).meters))  # result in distance 100 square meters)
print("Distance from the ground truth 200m^2 (day 3):", (geodesic(Ground_truth, coordinate_200).meters))  # result in distance 200 square meters)
print("Distance from the ground truth 300m^2 (day 3):", (geodesic(Ground_truth, coordinate_300).meters))  # result in distance 300 square meters)